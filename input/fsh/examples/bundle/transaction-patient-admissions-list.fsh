...
* entry[+].fullUrl = "Encounter/Encounter-AdamTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-AdamTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-AdamTest-Triage-Admission-Respiratory"
* entry[+].fullUrl = "Encounter/Encounter-BobTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-BobTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-BobTest-Triage-Admission-Respiratory"
* entry[+].fullUrl = "Encounter/Encounter-CarolTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-CarolTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-CarolTest-Triage-Admission-Respiratory"
* entry[+].fullUrl = "Encounter/Encounter-DougTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-DougTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-DougTest-Triage-Admission-Respiratory"
* entry[+].fullUrl = "Encounter/Encounter-EoinTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-EoinTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-EoinTest-Triage-Admission-Respiratory"
* entry[+].fullUrl = "Encounter/Encounter-FredTest-Triage-Admission-Respiratory"
* entry[=].resource = Encounter-FredTest-Triage-Admission-Respiratory
* entry[=].request.method = #PUT
* entry[=].request.url = "Encounter/Encounter-FredTest-Triage-Admission-Respiratory"
...
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-AdamTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-AdamTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-AdamTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-AdamTest-ACVPU"
* entry[=].resource = ServiceRequest-AdamTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-AdamTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-AdamTest-BreathingRoom"
* entry[=].resource = ServiceRequest-AdamTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-AdamTest-BreathingRoom"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-BobTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-BobTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-BobTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-BobTest-ACVPU"
* entry[=].resource = ServiceRequest-BobTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-BobTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-BobTest-BreathingRoom"
* entry[=].resource = ServiceRequest-BobTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-BobTest-BreathingRoom"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-CarolTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-CarolTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-CarolTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-CarolTest-ACVPU"
* entry[=].resource = ServiceRequest-CarolTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-CarolTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-CarolTest-BreathingRoom"
* entry[=].resource = ServiceRequest-CarolTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-CarolTest-BreathingRoom"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-DougTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-DougTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-DougTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-DougTest-ACVPU"
* entry[=].resource = ServiceRequest-DougTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-DougTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-DougTest-BreathingRoom"
* entry[=].resource = ServiceRequest-DougTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-DougTest-BreathingRoom"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-EoinTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-EoinTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-EoinTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-EoinTest-ACVPU"
* entry[=].resource = ServiceRequest-EoinTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-EoinTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-EoinTest-BreathingRoom"
* entry[=].resource = ServiceRequest-EoinTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-EoinTest-BreathingRoom"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-FredTest-ClerkAssessment"
* entry[=].resource = ServiceRequest-FredTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-FredTest-ClerkAssessment"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-FredTest-ACVPU"
* entry[=].resource = ServiceRequest-FredTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-FredTest-ACVPU"
* entry[+].fullUrl = "ServiceRequest/ServiceRequest-FredTest-BreathingRoom"
* entry[=].resource = ServiceRequest-FredTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "ServiceRequest/ServiceRequest-FredTest-BreathingRoom"

// Tasks

* entry[+].fullUrl = "Task/Task-AdamTest-ClerkAssessment"
* entry[=].resource = Task-AdamTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-AdamTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-AdamTest-ACVPU"
* entry[=].resource = Task-AdamTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-AdamTest-ACVPU"
* entry[+].fullUrl = "Task/Task-AdamTest-BreathingRoom"
* entry[=].resource = Task-AdamTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-AdamTest-BreathingRoom"
* entry[+].fullUrl = "Task/Task-BobTest-ClerkAssessment"
* entry[=].resource = Task-BobTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-BobTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-BobTest-ACVPU"
* entry[=].resource = Task-BobTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-BobTest-ACVPU"
* entry[+].fullUrl = "Task/Task-BobTest-BreathingRoom"
* entry[=].resource = Task-BobTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-BobTest-BreathingRoom"
* entry[+].fullUrl = "Task/Task-CarolTest-ClerkAssessment"
* entry[=].resource = Task-CarolTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-CarolTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-CarolTest-ACVPU"
* entry[=].resource = Task-CarolTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-CarolTest-ACVPU"
* entry[+].fullUrl = "Task/Task-CarolTest-BreathingRoom"
* entry[=].resource = Task-CarolTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-CarolTest-BreathingRoom"
* entry[+].fullUrl = "Task/Task-DougTest-ClerkAssessment"
* entry[=].resource = Task-DougTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-DougTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-DougTest-ACVPU"
* entry[=].resource = Task-DougTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-DougTest-ACVPU"
* entry[+].fullUrl = "Task/Task-DougTest-BreathingRoom"
* entry[=].resource = Task-DougTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-DougTest-BreathingRoom"
* entry[+].fullUrl = "Task/Task-EoinTest-ClerkAssessment"
* entry[=].resource = Task-EoinTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-EoinTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-EoinTest-ACVPU"
* entry[=].resource = Task-EoinTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-EoinTest-ACVPU"
* entry[+].fullUrl = "Task/Task-EoinTest-BreathingRoom"
* entry[=].resource = Task-EoinTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-EoinTest-BreathingRoom"
* entry[+].fullUrl = "Task/Task-FredTest-ClerkAssessment"
* entry[=].resource = Task-FredTest-ClerkAssessment
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-FredTest-ClerkAssessment"
* entry[+].fullUrl = "Task/Task-FredTest-ACVPU"
* entry[=].resource = Task-FredTest-ACVPU
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-FredTest-ACVPU"
* entry[+].fullUrl = "Task/Task-FredTest-BreathingRoom"
* entry[=].resource = Task-FredTest-BreathingRoom
* entry[=].request.method = #PUT
* entry[=].request.url = "Task/Task-FredTest-BreathingRoom"