Instance: Bundle-RegisterPatientInReception-Scenario.1-Delete
InstanceOf: Bundle
Description: "Register Patient in Reception - Scenario 1. Not found in local clinical or national demographics system. Delete resources."
Usage: #example
* id = "RegisterPatientInReception-Scenario.1-Delete"
* type = #transaction
