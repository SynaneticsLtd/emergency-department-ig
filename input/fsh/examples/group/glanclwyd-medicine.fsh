Instance: Group-GlanClwyd-Medicine-WaitingRoom
InstanceOf: Group
Description: "Group defining patients in Glan Clwyd ED waitingroom that have been triaged."
Usage: #example
...
* characteristic[=].code.text = "Organization.identifier.where(value='RL121')"
* characteristic[=].valueCodeableConcept.coding[0].code = $ods-code#RL121
* characteristic[=].exclude = false

// Members

* member[0].entity = Reference(Patient/Patient-AdamTest)
* member[=].period.start = "2000-01-01"
* member[+].entity = Reference(Patient/Patient-BobTest)
* member[=].period.start = "2000-01-01"
